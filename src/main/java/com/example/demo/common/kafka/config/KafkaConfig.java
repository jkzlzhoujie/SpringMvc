package com.example.demo.common.kafka.config;

import com.example.demo.common.kafka.listener.ConsumerListener;
 ...
 * kafka
 * 由于kafka 对应服务器 虚拟机没有 开启所以先注释，服务开启后可以访问
 */
//@Configuration
//@EnableKafka
